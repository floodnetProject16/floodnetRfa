...
Before fitting the POT model, Mann-Kendall's test examines the presence of trend trends in the exceedances. 
Similarly, logistic regression models with time as a covariate look for changes in the exceedance rate.
More precisely, F-tests compare polynomial trends of order 1 to 3 to a constant model, which is summarized by the lowest p-value that provides evidence that at least one of the considered trend was significant.
...
icor <- IntersiteCorData(hydat, gauged$site)
